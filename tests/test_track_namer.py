...
def reset_client():
    """Reset the singleton _client before each test to ensure isolation."""
    import core.track_namer

    core.track_namer._client = None
    yield
    core.track_namer._client = None
...
async def test_generate_track_name_valid_response():
    ...
    with patch("core.track_namer._client", mock_client):
