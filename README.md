...
- **GlobalState** — single Pydantic v2 source of truth (93 fields), persisted to SQLite WAL
...
| Visuals | Three.js, WebGL, Xvfb + Chromium SwiftShader (headless) |
...
- Xvfb + Chromium (for headless overlay capture — `apt install xvfb chromium-browser`)
